...
const Home = () => {
  return (
    <div name="home" className="w-full p-10 ">
      <div className="flex flex-col items-center justify-around max-w-screen-lg px-16 m-auto lg:flex-row-reverse md:flex-col gap-x-16 ">
        <div className=" flex justify-center items-centerbg-transparent overflow-hidden min-w-[280px] rounded-2xl mt-16 border-cyan-400 group md:flex  ">
          <img
            src={HeroImage}
            alt="my profile"
            className=" duration-700  shadow-md w-[100%]   hover:scale-105"
          />
        </div>
        <div className="mt-10 ">
